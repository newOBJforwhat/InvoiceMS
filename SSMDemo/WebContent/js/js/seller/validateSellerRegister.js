...
$(function () {
    ...
    $(".inputFaild").blur(function(){
        ...
        if(inputName === "Shop"){
            validateShop(inputName);
        }
        else if(inputName === "RegisterUsername") {
...
/*
    店铺名称校验
 */
function validateShop(inputName){
...
function changeCode() {
    ...
    imgNode.src = "http://localhost:8080/Shop/verifyCode?t=" + Math.random();  // 防止浏览器缓存的问题     
}
